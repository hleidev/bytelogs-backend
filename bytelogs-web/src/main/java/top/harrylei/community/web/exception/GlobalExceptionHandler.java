...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handleMethodArgumentNotValidException(MethodArgumentNotValidException e,
        ...
        return Result.fail(ResultCode.INVALID_PARAMETER, message);
    }
    ...
    public Result<Void> handleMissingServletRequestParameterException(MissingServletRequestParameterException e,
        ...
        return Result.fail(ResultCode.INVALID_PARAMETER, e.getParameterName());
    }
    ...
    public Result<Void> handleAuthDenied(AuthorizationDeniedException e, HttpServletRequest req) {
        logBusinessException("权限不足", "访问被拒绝", req, e);
        return Result.fail(ResultCode.FORBIDDEN, "权限不足");
    }
    ...
    public Result<Void> handleHttpMessageNotReadableException(HttpMessageNotReadableException e,
        ...
        return Result.fail(ResultCode.INVALID_PARAMETER, "请求体格式错误或解析失败");
    }
    ...
    public Result<Void> handleJsonProcessingException(JsonProcessingException e, HttpServletRequest request) {
        logBusinessException("JSON处理异常", "JSON格式错误", request, e);
        return Result.fail(ResultCode.INVALID_PARAMETER, "JSON格式错误");
    }
    ...
    public Result<Void> handleMaxUploadSizeExceededException(MaxUploadSizeExceededException e,
        ...
        return Result.fail(ResultCode.INVALID_PARAMETER, "上传文件大小超过限制");
    }
    ...
    public Result<Void> handleOptimisticLockingFailureException(OptimisticLockingFailureException e,
        ...
        return Result.fail(ResultCode.INTERNAL_ERROR, "数据已被其他用户修改，请刷新后重试");
    }
    ...
    public Result<Void> handleDataAccessException(DataAccessException e, HttpServletRequest request) {
        ...
        return Result.fail(ResultCode.INTERNAL_ERROR, "数据库操作异常");
    }
    ...
    private String getBusinessCodeLocation(Exception e) {
        ...
        for (StackTraceElement element : stackTrace) {
            ...
            // 查找第一个业务代码位置
            if (className.startsWith("top.harrylei.community.service")
                    || className.startsWith("top.harrylei.community.web")
                    || className.startsWith("top.harrylei.community.core")) {

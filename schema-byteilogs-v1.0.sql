...
(
    ...
    `official`    bigint unsigned  NOT NULL DEFAULT 0 COMMENT '官方状态：0-非官方，1-官方',
    `topping`    bigint unsigned  NOT NULL DEFAULT 0 COMMENT '置顶状态：0-不置顶，1-置顶',
    `cream`      bigint unsigned  NOT NULL DEFAULT 0 COMMENT '加精状态：0-不加精，1-加精',

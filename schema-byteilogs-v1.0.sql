...
(
    ...
    avatar      varchar(128)    not null default '' comment '用户图像',
...
(
    ...
    `official`        tinyint unsigned  NOT NULL DEFAULT 0 COMMENT '官方状态：0-非官方，1-官方',
    `topping`         tinyint unsigned  NOT NULL DEFAULT 0 COMMENT '置顶状态：0-不置顶，1-置顶',
    `cream`           tinyint unsigned  NOT NULL DEFAULT 0 COMMENT '加精状态：0-不加精，1-加精',
    `status`          tinyint unsigned NOT NULL DEFAULT 0 COMMENT '状态：0-草稿，1-已发布，2-待审核',
...
(
    ...
    `latest`      tinyint unsigned NOT NULL DEFAULT 1 COMMENT '是否为最新版本',
    `published`   tinyint unsigned NOT NULL DEFAULT 0 COMMENT '是否为发布版本',
...
(
    `id`            bigint unsigned  NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `category_name` varchar(32)      NOT NULL DEFAULT '' COMMENT '类目名称',
